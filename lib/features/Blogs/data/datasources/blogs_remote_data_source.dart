...
abstract class DebatesRemoteDataSource {
  Future<DebateModel> getAnnouncedDebates({required int currentPage});
}
...
class DebatesRemoteDataSourceImpl implements DebatesRemoteDataSource {
  ...
  @override
  Future<DebateModel> getAnnouncedDebates({required int currentPage}) async {
    ...
    if (response.statusCode == 200) {
      ...
      final debatesResponse = DebateModel.fromJson(jsonData);
