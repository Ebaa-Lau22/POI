...
// class TeamsConfirmDebatesPage extends StatefulWidget {
//   @override
//   State<TeamsConfirmDebatesPage> createState() => _TeamsConfirmDebatesPageState();
// }

// class _TeamsConfirmDebatesPageState extends State<TeamsConfirmDebatesPage> {
...
//                           final debate = state.debates[index];
//                           return Container(
//                             height: 100,
...
import 'package:poi/features/Debates/presentation/bloc/debates_cubit.dart';
import 'package:poi/features/Debates/presentation/bloc/debates_states.dart';
import 'package:poi/features/Debates/presentation/pages/Teams_confirm_debate_details_page.dart';

class TeamsConfirmDebatesPage extends StatefulWidget {
  @override
  State<TeamsConfirmDebatesPage> createState() =>
      _TeamsConfirmDebatesPageState();
}
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final debate = state.debates[index];
                          return TeamsConfirmDebateDebateWidget(
                            debate: debate,
                            index: index,
                          );
                        },
...
class TeamsConfirmDebateDebateWidget extends StatefulWidget {
  const TeamsConfirmDebateDebateWidget({
    super.key,
  ...
  @override
  State<TeamsConfirmDebateDebateWidget> createState() =>
      _TeamsConfirmDebateDebateWidgetState();
}

class _TeamsConfirmDebateDebateWidgetState
    extends State<TeamsConfirmDebateDebateWidget> {
  String savedGuard = "";
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        navigateTo(
          context,
          TeamsConfirmDebateDetailsPage(debate: widget.debate),
        );
      },
      child: Container(
        height: 100,
