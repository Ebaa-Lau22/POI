...
class FinishedDebatesPage extends StatefulWidget {
  @override
  State<FinishedDebatesPage> createState() => _FinishedDebatesPageState();
}

class _FinishedDebatesPageState extends State<FinishedDebatesPage> {
...
class FinishedDebateWidget extends StatefulWidget {
  const FinishedDebateWidget({
    super.key,
  ...
  @override
  State<FinishedDebateWidget> createState() =>
      _PlayersConfirmDebateWidgetState();
}

class _PlayersConfirmDebateWidgetState extends State<FinishedDebateWidget> {
  String savedGuard = "";
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        if (savedGuard == "judge") {
          navigateTo(context, FeedbackPage(debate: widget.debate));
        }
         if(savedGuard == "debater"){
           navigateTo(context, JudgeRatingPage(debate: widget.debate));
         }
      },
      child: Container(
        // height: 100,
